"""
High Altitude Platform Station (HAPS) Stratospheric Thermal & Energy Calculator
==============================================================================
Thermodynamic and energy balance tool for long-endurance solar-powered HAPS 
operating in the stratosphere (18-25 km altitude).

Directly useful to:
  - Voltitude (Farnborough, UK) — StratoGuard project, Project Aether leader
  - BAE Systems / Prismatic (Farnborough, UK) — PHASA-35 solar HAPS aircraft
  - Airbus Defence & Space / AALTO HAPS (Farnborough, UK) — Zephyr programme

Physics:
  - ISA multi-layer atmosphere (0-80 km)
  - Diurnal solar irradiance model as function of latitude, day of year, and time
  - Hull steady-state radiation and convection balance
  - Helium gas expansion and diurnal buoyancy/altitude excursion
  - Solar panel energy harvest, battery sizing, and payload/avionics power budget
  - Pressurized electronics payload pod thermal balance and heater sizing

References:
  - European Cooperation for Space Standardisation: ECSS-E-HB-31-01A (Thermal Design Handbook)
  - Noll et al. (2004), Technical Challenges for Solar-Powered HAPS
  - Fay & Riddell (1958), Stagnation point heat transfer relations

Usage:
  python haps_thermal.py             # full 24h diurnal cycle plots
  python haps_thermal.py --point     # print PHASA-35 reference design point table
...
def plot_all(output_path):
    ...
    platforms = ['Solar HAPS\n(PHASA-35)', 'Lighter-than-Air\nBalloon', 'LEO Small Sat\n(SSTL-100)', 'Turboprop UAV\n(Reaper)']
