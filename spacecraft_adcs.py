"""
Spacecraft 3D Attitude Determination & Control System (ADCS) Simulator
======================================================================
Simulates rigid-body rotational dynamics of a satellite in orbit.
Implements magnetic B-dot detumbling control and 3-axis reaction wheel PID pointing.

Directly relevant to satellite systems engineering at groups like Surrey Satellite 
Technology Ltd (SSTL), AAC Clyde Space, Kepler Communications, and Open Cosmos.

Physics:
  - Rotational kinematics using unit quaternions (to avoid gimbal lock)
  - Rotational dynamics using Euler's equations of motion
  - B-dot control law: m_dipole = -K_bdot * dB/dt, torque = m x B
  - Reaction wheel closed-loop PID attitude stabilization: T = -Kp*q_err - Kd*omega

Usage:
  python spacecraft_adcs.py             # Run default simulation and generate plots
  python spacecraft_adcs.py --point     # Print design verification summary tables
