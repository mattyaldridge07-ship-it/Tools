...
def isa_atmosphere(altitude_m):
    """basic multi-layer atmosphere model for standalone use"""
    layers = [
...
def compute_dkr_heat_flux(M, alt_km, R_n_mm):
    """stagnation point heat flux via the Detra-Kemp-Riddell approximation, returns W/cm²"""
...
# Fay & Riddell experimental points
...
def run_apollo_trajectory():
    """
    Apollo 11 entry: V0 = 11 km/s, gamma0 = -6.5°, initial altitude = 120 km
...
def generate_report_markdown(output_path='validation_report.md'):
    with open(output_path, 'w', encoding='utf-8') as f:
        ...
        # published figure: ~450 W/cm^2 at 65 km
