...
### `f1_brake_thermal.py` — High-Performance Carbon-Carbon Brake Disc

Transient thermal model of a motorsport-class brake disc during a race lap.
...
**Key finding:** High-performance discs routinely exceed 750°C in dry conditions —
